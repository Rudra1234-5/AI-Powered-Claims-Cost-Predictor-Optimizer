...
# AI-Powered Prediction Section
    ...
    if prediction_option == "Forecast Data using Prophet":
        ...
        if st.button("Ask") and user_question:
            try:
                context = f"You are a helpful healthcare analyst. Here's a healthcare dataset summary:\n\n{df.head().to_string()}. If asked for future Data Forecast using Prophet from prophet. Use the file path for the csv as Gen_AI_sample_data csv.Use st.pyplot(fig) to show figues as well"
                messages = [
