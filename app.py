...
# AI-Powered Prediction Section
    ...
    if st.button("Ask") and user_question:
        try:
            ...
            # Let GPT generate the response directly
            messages = [
            ...
            # Execute Prophet forecast if needed and output forecast values
            if "forecast" in content.lower():
                metric = 'paid_amount'  # We assume 'paid_amount' is the default metric for forecasting
                forecast_period = 12  # Default to 12 months forecast
