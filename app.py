...
if sidebar_selection == "Select Analysis Type":
    st.sidebar.markdown("### Select Prediction Type")
    prediction_type = st.sidebar.selectbox("Choose an AI-powered Prediction", [
...
# AI-Powered Prediction Section
    ...
    prediction_option = st.selectbox("Select a Prediction Type", ["Forecast Data using Prophet", "Chat with AI"])
    ...
    if prediction_option == "Forecast Data using Prophet":
        ...
        if st.button("Ask") and user_question:
            try:
                ...
                # Check for embedded code in the response
